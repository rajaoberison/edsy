...
\NormalTok{raw.data \textless{}{-}}\StringTok{ }\KeywordTok{read\_sav}\NormalTok{(}\StringTok{\textquotesingle{}data/ypccc.hurricane.sav\textquotesingle{}}\NormalTok{)}
\NormalTok{raw.data \textless{}{-}}\StringTok{ }\NormalTok{raw.data }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\KeywordTok{filter}\NormalTok{(raw.data}\OperatorTok{$}\NormalTok{Q1}\OperatorTok{==}\DecValTok{1} \OperatorTok{||}\StringTok{ }\NormalTok{raw.data}\OperatorTok{$}\NormalTok{Q2}\OperatorTok{==}\DecValTok{1}\NormalTok{)}
\NormalTok{raw.data \textless{}{-}}\StringTok{ }\NormalTok{raw.data }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\KeywordTok{filter}\NormalTok{(}\OperatorTok{!}\KeywordTok{is.na}\NormalTok{(raw.data}\OperatorTok{$}\NormalTok{Q3), raw.data}\OperatorTok{$}\NormalTok{Q3}\OperatorTok{!=}\DecValTok{2}\NormalTok{, raw.data}\OperatorTok{$}\NormalTok{Q3}\OperatorTok{!=}\DecValTok{3}\NormalTok{)}

\NormalTok{raw.data}\OperatorTok{$}\NormalTok{S5\_cluster \textless{}{-}}\StringTok{ }\KeywordTok{recode}\NormalTok{(}\KeywordTok{as.character}\NormalTok{(raw.data}\OperatorTok{$}\NormalTok{S5\_cluster), }\StringTok{\textquotesingle{}1\textquotesingle{}}\NormalTok{=}\StringTok{\textquotesingle{}DieHards\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}2\textquotesingle{}}\NormalTok{=}\StringTok{\textquotesingle{}Reluctant\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}4\textquotesingle{}}\NormalTok{=}\StringTok{\textquotesingle{}Optimists\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}3\textquotesingle{}}\NormalTok{=}\StringTok{\textquotesingle{}Constrained\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}5\textquotesingle{}}\NormalTok{=}\StringTok{\textquotesingle{}First Out\textquotesingle{}}\NormalTok{)}
\NormalTok{raw.data}\OperatorTok{$}\NormalTok{S5\_cluster \textless{}{-}}\StringTok{ }\KeywordTok{factor}\NormalTok{(raw.data}\OperatorTok{$}\NormalTok{S5\_cluster, }\DataTypeTok{ordered=}\NormalTok{T, }\DataTypeTok{levels=}\KeywordTok{c}\NormalTok{(}\StringTok{\textquotesingle{}First Out\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}Constrained\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}Optimists\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}Reluctant\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}DieHards\textquotesingle{}}\NormalTok{))}
\NormalTok{data \textless{}{-}}\StringTok{ }\NormalTok{raw.data[}\OperatorTok{!}\KeywordTok{is.na}\NormalTok{(raw.data}\OperatorTok{$}\NormalTok{S5\_cluster),]}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{ggplot2-example-1}{%
\subsection{\texorpdfstring{\texttt{ggplot2} Example 1}{ggplot2 Example 1}}\label{ggplot2-example-1}}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Q7. Generally speaking, how prepared were you for the storm(s) you experienced?}
\NormalTok{data}\OperatorTok{$}\NormalTok{Q7 \textless{}{-}}\StringTok{ }\KeywordTok{as\_factor}\NormalTok{(data}\OperatorTok{$}\NormalTok{Q7)}
\NormalTok{data}\OperatorTok{$}\NormalTok{Q7 \textless{}{-}}\StringTok{ }\KeywordTok{recode}\NormalTok{(}\KeywordTok{as.character}\NormalTok{(data}\OperatorTok{$}\NormalTok{Q7), }
                  \StringTok{\textquotesingle{}Fully Prepared\textquotesingle{}}\NormalTok{=}\StringTok{\textquotesingle{}Fully/Very prepared\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}Very Prepared\textquotesingle{}}\NormalTok{=}\StringTok{\textquotesingle{}Fully/Very prepared\textquotesingle{}}\NormalTok{, }
                  \StringTok{\textquotesingle{}A Little Prepared\textquotesingle{}}\NormalTok{=}\StringTok{\textquotesingle{}A little/Not at all prepared\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}Not at all Prepared\textquotesingle{}}\NormalTok{=}\StringTok{\textquotesingle{}A little/Not at all prepared\textquotesingle{}}
\NormalTok{                  )}

\NormalTok{data}\OperatorTok{$}\NormalTok{Q7 \textless{}{-}}\StringTok{ }\KeywordTok{factor}\NormalTok{(data}\OperatorTok{$}\NormalTok{Q7, }\DataTypeTok{ordered=}\NormalTok{T, }\DataTypeTok{levels=}\KeywordTok{c}\NormalTok{(}\StringTok{\textquotesingle{}Fully/Very prepared\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}A little/Not at all prepared\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}Moderately Prepared\textquotesingle{}}\NormalTok{))}

\NormalTok{Q7\_data \textless{}{-}}\StringTok{ }\NormalTok{data }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(Q7, S5\_cluster, Final\_wgt\_pop) }\OperatorTok{\%\textgreater{}\%}
\StringTok{  }\CommentTok{\# na.omit() \%\textgreater{}\%}
\StringTok{  }\KeywordTok{group\_by}\NormalTok{(S5\_cluster, Q7) }\OperatorTok{\%\textgreater{}\%}
\StringTok{  }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{Q7.wgt =} \KeywordTok{sum}\NormalTok{(Final\_wgt\_pop)) }\OperatorTok{\%\textgreater{}\%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{freq.wgt =} \KeywordTok{round}\NormalTok{(}\DecValTok{100}\OperatorTok{*}\NormalTok{Q7.wgt}\OperatorTok{/}\KeywordTok{sum}\NormalTok{(Q7.wgt))) }\OperatorTok{\%\textgreater{}\%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(Q7}\OperatorTok{!=}\StringTok{\textquotesingle{}Moderately Prepared\textquotesingle{}}\NormalTok{, }\OperatorTok{!}\KeywordTok{is.na}\NormalTok{(Q7))}
...
\includegraphics{edsy_files/figure-latex/example-1-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Q31. Is your home located in a hurricane evacuation zone, or not?}
\NormalTok{data}\OperatorTok{$}\NormalTok{Q31 \textless{}{-}}\StringTok{ }\KeywordTok{as\_factor}\NormalTok{(data}\OperatorTok{$}\NormalTok{Q31)}
\NormalTok{data}\OperatorTok{$}\NormalTok{Q31 \textless{}{-}}\StringTok{ }\KeywordTok{factor}\NormalTok{(data}\OperatorTok{$}\NormalTok{Q31, }\DataTypeTok{ordered=}\NormalTok{T, }\DataTypeTok{levels=}\KeywordTok{c}\NormalTok{(}\StringTok{\textquotesingle{}No\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}Not Sure\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}Yes\textquotesingle{}}\NormalTok{))}

\NormalTok{Q31\_data \textless{}{-}}\StringTok{ }\NormalTok{data }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(Q31, S5\_cluster, Final\_wgt\_pop) }\OperatorTok{\%\textgreater{}\%}
\StringTok{  }\CommentTok{\# na.omit() \%\textgreater{}\%}
\StringTok{  }\KeywordTok{group\_by}\NormalTok{(S5\_cluster, Q31) }\OperatorTok{\%\textgreater{}\%}
\StringTok{  }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{Q31.wgt =} \KeywordTok{sum}\NormalTok{(Final\_wgt\_pop)) }\OperatorTok{\%\textgreater{}\%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{freq.wgt =} \KeywordTok{round}\NormalTok{(}\DecValTok{100}\OperatorTok{*}\NormalTok{Q31.wgt}\OperatorTok{/}\KeywordTok{sum}\NormalTok{(Q31.wgt))) }\OperatorTok{\%\textgreater{}\%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(}\OperatorTok{!}\KeywordTok{is.na}\NormalTok{(Q31))}
...
\includegraphics{edsy_files/figure-latex/example-2-1.pdf}
...
\includegraphics{edsy_files/figure-latex/example-3-1.pdf}

\hypertarget{interactive-graph-with-plotly}{%
\section{\texorpdfstring{Interactive graph with \texttt{plotly}}{Interactive graph with plotly}}\label{interactive-graph-with-plotly}}

Creating an interactive version of the previous graphs is pretty simple using \texttt{plotly}. You just have to separate the data by group.

\hypertarget{plotly-example-1}{%
\subsection{\texorpdfstring{\texttt{plotly} Example 1}{plotly Example 1}}\label{plotly-example-1}}

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(plotly)}

\NormalTok{Q7.prepared \textless{}{-}}\StringTok{ }\NormalTok{Q7\_data }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(Q7}\OperatorTok{==}\StringTok{\textquotesingle{}Fully/Very prepared\textquotesingle{}}\NormalTok{)}
\NormalTok{Q7.not.prepared \textless{}{-}}\StringTok{ }\NormalTok{Q7\_data }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(Q7}\OperatorTok{==}\StringTok{\textquotesingle{}A little/Not at all prepared\textquotesingle{}}\NormalTok{)}

\KeywordTok{plot\_ly}\NormalTok{(}\DataTypeTok{x=}\NormalTok{Q7.prepared}\OperatorTok{$}\NormalTok{S5\_cluster, }\DataTypeTok{y=}\NormalTok{Q7.prepared}\OperatorTok{$}\NormalTok{freq.wgt, }\DataTypeTok{type=}\StringTok{\textquotesingle{}bar\textquotesingle{}}\NormalTok{, }\DataTypeTok{name=}\StringTok{\textquotesingle{}Fully/Very prepared\textquotesingle{}}\NormalTok{) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{add\_trace}\NormalTok{(}\DataTypeTok{x=}\NormalTok{Q7.not.prepared}\OperatorTok{$}\NormalTok{S5\_cluster, }\DataTypeTok{y=}\NormalTok{Q7.not.prepared}\OperatorTok{$}\NormalTok{freq.wgt, }\DataTypeTok{name=}\StringTok{\textquotesingle{}A little/Not at all prepared\textquotesingle{}}\NormalTok{) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{layout}\NormalTok{(}\DataTypeTok{barmode =} \StringTok{\textquotesingle{}group\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\hypertarget{htmlwidget-19c5f7e5398d74df67b1}{}

\hypertarget{plotly-example-2}{%
\subsection{\texorpdfstring{\texttt{plotly} Example 2}{plotly Example 2}}\label{plotly-example-2}}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Q31.yes \textless{}{-}}\StringTok{ }\NormalTok{Q31\_data }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(Q31}\OperatorTok{==}\StringTok{\textquotesingle{}Yes\textquotesingle{}}\NormalTok{)}
\NormalTok{Q31.notsure \textless{}{-}}\StringTok{ }\NormalTok{Q31\_data }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(Q31}\OperatorTok{==}\StringTok{\textquotesingle{}Not Sure\textquotesingle{}}\NormalTok{)}
\NormalTok{Q31.no \textless{}{-}}\StringTok{ }\NormalTok{Q31\_data }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(Q31}\OperatorTok{==}\StringTok{\textquotesingle{}No\textquotesingle{}}\NormalTok{)}

\KeywordTok{plot\_ly}\NormalTok{(}\DataTypeTok{x=}\NormalTok{Q31.yes}\OperatorTok{$}\NormalTok{S5\_cluster, }\DataTypeTok{y=}\NormalTok{Q31.yes}\OperatorTok{$}\NormalTok{freq.wgt, }\DataTypeTok{type=}\StringTok{\textquotesingle{}bar\textquotesingle{}}\NormalTok{, }\DataTypeTok{name=}\StringTok{\textquotesingle{}Yes\textquotesingle{}}\NormalTok{, }\DataTypeTok{marker =} \KeywordTok{list}\NormalTok{(}\DataTypeTok{color =} \StringTok{\textquotesingle{}\#DC7633\textquotesingle{}}\NormalTok{), }\DataTypeTok{text =}\NormalTok{ Q31.yes}\OperatorTok{$}\NormalTok{freq.wgt, }\DataTypeTok{textposition =} \StringTok{\textquotesingle{}auto\textquotesingle{}}\NormalTok{) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{add\_trace}\NormalTok{(}\DataTypeTok{x=}\NormalTok{Q31.notsure}\OperatorTok{$}\NormalTok{S5\_cluster, }\DataTypeTok{y=}\NormalTok{Q31.notsure}\OperatorTok{$}\NormalTok{freq.wgt, }\DataTypeTok{name=}\StringTok{\textquotesingle{}Not Sure\textquotesingle{}}\NormalTok{, }\DataTypeTok{marker =} \KeywordTok{list}\NormalTok{(}\DataTypeTok{color =} \StringTok{\textquotesingle{}\#5D6D7E\textquotesingle{}}\NormalTok{)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{add\_trace}\NormalTok{(}\DataTypeTok{x=}\NormalTok{Q31.no}\OperatorTok{$}\NormalTok{S5\_cluster, }\DataTypeTok{y=}\NormalTok{Q31.no}\OperatorTok{$}\NormalTok{freq.wgt, }\DataTypeTok{name=}\StringTok{\textquotesingle{}No\textquotesingle{}}\NormalTok{, }\DataTypeTok{marker =} \KeywordTok{list}\NormalTok{(}\DataTypeTok{color =} \StringTok{\textquotesingle{}\#5499C7\textquotesingle{}}\NormalTok{)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{layout}\NormalTok{(}\DataTypeTok{barmode =} \StringTok{\textquotesingle{}stack\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
US & https://climatecommunication.yale.edu/ & Yale Program on Climate Change Communication\\
US & https://data.census.gov/cedsci/ & Census surveys\\
US & https://www.epa.gov/ejscreen/download-ejscreen-data & Environmental justice\\
US & https://www.data.gov/ & Agriculture, Climate, Consumer, Ecosystems, Education, Energy, Finance, Health, Local Government, Manufacturing, Maritime, Ocean, Public Safety, Science \& Research\\
\addlinespace
US & https://simplyanalytics.com/ & Demography, Business, Health, Marketing\\
